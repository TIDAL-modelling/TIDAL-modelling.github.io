...
# Demo data located here: https://github.com/TIDAL-modelling/TIDAL/tree/main/data
...
df
```
## Interaction Variable (factor with two levels) {.tabset}
...
## Interaction Variable (factor with four levels) {.tabset}
